...
export const treeMap = () => {
    ...
    const addDiv = () => {
        ...
        newDiv.setAttribute("id", "treemap")
...
// read json data
    ...
    const root = d3.hierarchy(newSeed).sum(function(d){return d.value}) // Here the size of each leave is given in the 'value' field in input data
