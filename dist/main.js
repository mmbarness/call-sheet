...
var movie_title = 'The Interpreter';
var movie_url = "https://api.themoviedb.org/3/search/movie?api_key=".concat(api_key, "&language=en-US&query=").concat(movie_title, "&page=1&include_adult=false");
var movie_id;
...
function _getMovie() {
  _getMovie = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var url,
        response,
        _args = arguments;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = _args.length > 0 && _args[0] !== undefined ? _args[0] : movie_url;
            _context.next = 3;
            return fetch(url, {
              method: 'GET'
            });
...
function getMovieCredits() {
  return _getMovieCredits.apply(this, arguments);
}

function _getMovieCredits() {
  _getMovieCredits = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var url,
        movie,
        credits_url,
        response,
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            url = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : 0;
            _context2.next = 3;
            return getMovie();
